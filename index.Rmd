...
```{r fig.cap="source: Adapted from Kelleher et al., 2019", echo=FALSE, out.width="500px", fig.align="center"}
knitr::include_graphics("figures/fig_1_b_wo_caption_adapted.png")
```
...
```{r sequencing-costs-1, fig.cap="source: genome.gov/sequencingcosts", echo=FALSE, fig.align="center", fig.height=6, fig.width=10, message=FALSE}
...
sequencing_cost %>%
  ...
  annotate(
    x = as.Date("2001-07-01"), y = 1000000,
    xend = as.Date("2003-04-01"), yend = 43000000, 
    geom = "curve", curvature = -0.3, arrow = arrow(length = unit(3, "mm")), size = 0.8
  ) +
  annotate(geom = "text", x = as.Date("2001-06-01"), y = 350000, label = "first Human Genome\ncompleted*", hjust = "left", size = 6) 
...
```{r sequencing-costs-2, fig.cap="source: genome.gov/sequencingcosts", echo=FALSE, fig.align="center", fig.height=6, fig.width=10, message=FALSE}
...
sequencing_cost %>%
  ...
  annotate(geom = "text", x = as.Date("2001-06-01"), y = 350000, label = "first Human Genome\ncompleted*", hjust = "left", size = 6) +
  annotate(
    x = as.Date("2010-01-01"), y = 70000000,
    xend = as.Date("2006-01-01"), yend = 15000000, 
    geom = "curve", curvature = 0.3, arrow = arrow(length = unit(3, "mm")), size = 0.8
  ) +
  annotate(geom = "text", x = as.Date("2010-02-01"), y = 35000000, label = "introduction of\nHigh Throuput Sequencing", hjust = "left", size = 6)
...
```{r fig.cap="source: Adapted from Kelleher et al., 2019", echo=FALSE, out.width="600px", fig.align="center"}
knitr::include_graphics("figures/suppl_fig_17_top_adapted.png")
```
...
```{r fig.cap="source: Kelleher et al., 2019", echo=FALSE, out.width="800px", fig.align="center"}
knitr::include_graphics("figures/fig_1_c.png")
```
