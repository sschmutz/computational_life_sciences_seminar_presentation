...
data_sets %>%
  ...
  geom_text(aes(label = scales::comma(n, big.mark = "'")), hjust = 1.5, size = 8, fontface = "bold", family = "Noto Sans") +
...
**TODO: Maybe add another slide before the data set numbers tho show the trend/trhoughput of sequencing**  
